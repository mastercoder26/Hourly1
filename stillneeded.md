...
Use this file as your credential worksheet. Fill each section, then copy values into the actual env/config files.

Important:
- Do not commit real secrets to git.
- Keep this file local-only if you paste real keys here.
